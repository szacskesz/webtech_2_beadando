...
mongoimport --host $MONGO_HOST_IP --db sakila --collection shutter_colors --file jsons/shutter_colors.json --jsonArray
mongoimport --host $MONGO_HOST_IP --db sakila --collection shutter_materials --file jsons/shutter_materials.json --jsonArray
mongoimport --host $MONGO_HOST_IP --db sakila --collection shutter_types --file jsons/shutter_types.json --jsonArray
mongoimport --host $MONGO_HOST_IP --db sakila --collection orders --file jsons/orders.json --jsonArray
